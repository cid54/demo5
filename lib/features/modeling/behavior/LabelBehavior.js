...
export default function LabelBehavior(
  ...
  this.postExecute(["label.create"], function (event) {
    ...
    if (!is(element.labelTarget || element, "demo:BoardElement")) {
      return;
    }
    ...
    if (!di.label) {
      di.label = demoFactory.create("demoDi:DemoLabel", {
        bounds: demoFactory.create("dc:Bounds"),
      });
    }
...
LabelBehavior.$inject = ["eventBus", "modeling", "demoFactory", "textRenderer"];
