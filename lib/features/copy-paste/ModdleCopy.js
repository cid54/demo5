 ...
 */
export default function ModdleCopy(eventBus, demoFactory, moddle) {
...
ModdleCopy.$inject = ["eventBus", "demoFactory", "moddle"];
...
ModdleCopy.prototype.copyProperty = function (property, parent, propertyName) {
  ...
  if (isObject(property) && property.$type) {
    ...
    copiedProperty = self._demoFactory.create(property.$type);
