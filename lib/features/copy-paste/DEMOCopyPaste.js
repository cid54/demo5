...
export default function DEMOCopyPaste(demoFactory, eventBus, moddleCopy) {
  ...
  eventBus.on("copyPaste.pasteElement", function (context) {
    ...
    newBusinessObject = demoFactory.create(oldBusinessObject.$type);
...
DEMOCopyPaste.$inject = ["demoFactory", "eventBus", "moddleCopy"];
