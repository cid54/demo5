...
export default function TransactionCreatePopupProvider(
  config,
  popupMenu,
  modeling,
  translate,
  ...
  this._popupMenu.registerProvider("transaction-assignment-picker", this);
}

TransactionCreatePopupProvider.$inject = [
  "config.transactionPicker",
  "popupMenu",
  "modeling",
  "translate",
  "create",
...
TransactionCreatePopupProvider.prototype.getEntries = function (elements) {
  var self = this,
...
`;
    ...
    return {
      ...
      action: createAction("demo:Transaction", transaction.assignment),
    };
  });
