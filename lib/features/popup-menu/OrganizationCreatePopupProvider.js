...
export default function OrganizationCreatePopupProvider(
  config,
  popupMenu,
  modeling,
  translate,
  ...
  this._popupMenu.registerProvider("organization-assignment-picker", this);
}

OrganizationCreatePopupProvider.$inject = [
  "config.organizationPicker",
  "popupMenu",
  "modeling",
  "translate",
  "create",
...
OrganizationCreatePopupProvider.prototype.getEntries = function (elements) {
  var self = this,
...
`;
    ...
    return {
      ...
      action: createAction("demo:Organization", organization.assignment),
    };
  });
