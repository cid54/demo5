...
/**
 * An importer that adds DEMO elements to the canvas
 *
...
/**
 * Add DEMO element (semantic) to the canvas onto the
 * specified parent shape.
 */
DemoImporter.prototype.add = function (semantic, parentElement) {
  var di = semantic.di,
    element,
  ...
  // SHAPE
  else if (is(di, "demoDi:DemoShape")) {
 ...
 */
DemoImporter.prototype._attachBoundary = function (
  boundarySemantic,
  boundaryElement
) {
 ...
 */
DemoImporter.prototype.addLabel = function (semantic, element) {
 ...
 */
DemoImporter.prototype._getEnd = function (semantic, side) {
  var element,
    refSemantic,
    translate = this._translate;
...
DemoImporter.prototype._getSource = function (semantic) {
  return this._getEnd(semantic, "source");
};

DemoImporter.prototype._getTarget = function (semantic) {
  return this._getEnd(semantic, "target");
};

DemoImporter.prototype._getElement = function (semantic) {
...
function isFrameElement(semantic) {
  return is(semantic, "demo:Organization");
}
